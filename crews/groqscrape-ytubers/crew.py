...
class CustomCrew:
    ...
    def run(self):
        ...
        youtube_searcher = agents.youtube_searcher()
        # Define your custom agents and tasks here
        youtube_browser = agents.youtube_browser()
        # Define your custom agents and tasks here
        webscraper = agents.webscraper()

        
        # Custom tasks include agent name and variables as input
        search_youtubers = tasks.search_youtubers(
            youtube_searcher,
            var1=self.job_to_do,
            var2=f"focus on content in {self.language}",
        )
        # Custom tasks include agent name and variables as input
        list_the_best_videos_recently_created = tasks.list_the_best_videos_recently_created(
            youtube_browser,
            var1=self.job_to_do,
            var2=f"focus on content in {self.language}",
        )
        ...
        groqscrape = Crew(
            agents=[webscraper,youtube_searcher,youtube_browser],
            tasks=[search_youtubers,list_the_best_videos_recently_created],
            language="en",
