...
def get_teams_from_sheet(sheet):
    teams = sheet.get_worksheet_by_title('teams').get_all_records()
    return teams

def get_users_from_sheet(sheet):
    users = sheet.get_worksheet_by_title('users').get_all_records()
    return users

def get_teams_users_from_sheet(sheet):
    teams_users = sheet.get_worksheet_by_title('teams_users').get_all_records()
    return teams_users



def add_user(sheet, user_email):
    users_sheet = sheet.get_worksheet_by_title('users')
...
def add_team(sheet, team_name):
    ...
    teams_sheet = sheet.get_worksheet_by_title('teams')
...
def add_user_to_team(sheet, team_name, user_email):
    teams_users_sheet = sheet.get_worksheet_by_title('teams_users')
